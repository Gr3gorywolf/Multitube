...
namespace GR3_UiF
{
    public partial class dialogoeliminar : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
                ...
                cliente.Client.Send(Encoding.Default.GetBytes(indice.ToString()));
        ...
        private void customdialog_Load(object sender, EventArgs e)
        {
            ...
            cliente.Client.Connect(ipadres, 1024);
        ...
        {
            GR3_UiF.Properties.Settings.Default.eliminadorabierto = false;
            if (statusinical == "reprod")
            {
                cliente.Client.Send(Encoding.Default.GetBytes("play()"));
            }
