                         ...
                         ;
                            ...
                            else
                            {
                                ...
                                for (int i = 0; i < partes.Length; i++)
                                {
                                    ...
                                    string url1 = "http://decapi.me/youtube/videoid?search=" + laparalink[loc1].Split('=')[1];
...
if (capturado.Trim() == "fullscreen()"&& axWindowsMediaPlayer1.fullScreen==false && activado == true)
                    {
                        ...
                        activado = false;
                            try
                            {
                                ...
                                if (label3.Text.Trim() != "")
                                {
                                    var instancia =(fullscreen_mediaplayer) Application.OpenForms["fullscreen_mediaplayer"];
                                    if (instancia != null)
                                    {
                                    ...
                                    }else
                                    {
                                        this.Invoke((MethodInvoker)delegate
                                        {
                                            instancia = new fullscreen_mediaplayer();
                                            instancia.ipadre = ipadre;
                                            instancia.Show();
                  ...
                  if (capturado.Trim() == "fullscreen()" && axWindowsMediaPlayer1.fullScreen == true && activado == true)
                    ...
                    {
                            ////////////////////////////////////////////////////////////
                            if (agregado == true && activado == true && capturado.Trim().Length>=1) 
                            {
                                ...
                                if (textboxcopia != "%%%nulo%%%") {
                                    ...
                                    if (encontroparecido(textboxcopia.Split('¤')[1].Trim(), laparalink) == false) {
                                        ...
                                        if (lapara.Count == 1)
                                        {
                                            ...
                                            axWindowsMediaPlayer1.URL = "";
                                            string url1 = "http://decapi.me/youtube/videoid?search=" + laparalink[0].Split('=')[1]; ;
                                            //   webBrowser1.Navigate(url1);
                            ...
                            if (activado == true && capturado.Trim().Length>0 && !nocontienequerry(capturado) && capturado.Trim().Length >= 1)
                            {
                                ...
                                if (textboxcopia != "%%%nulo%%%")
                                {
                                    ...
                                    if (encontroparecido(textboxcopia.Split('¤')[1], laparalink) == false)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            anterior = textboxcopia.Split('¤')[0];
                                            axWindowsMediaPlayer1.URL = "";
                                            string url1 = "http://decapi.me/youtube/videoid?search=" + laparalink[locanterior].Split('=')[1];
                                            //  webBrowser1.Navigate(url1);
                                            actualizarlista();
            ...
            */
            ...
            if (lista != GR3_UiF.Properties.Settings.Default.lista)
            {
               ...
               for (int i=0;i<lapara.Count;i++)
                ...
                axWindowsMediaPlayer1.URL = "";
                string url1 = "http://decapi.me/youtube/videoid?search=" + laparalink[prrol];
                // webBrowser1.Navigate(url1);
            ...
            if (this.tubito2 != GR3_UiF.Properties.Settings.Default.tubito2 && GR3_UiF.Properties.Settings.Default.tubito.Trim() == "agregar")
            {
                if (encontroparecido(GR3_UiF.Properties.Settings.Default.laparalink, laparalink) == false)
                {
                    ...
                    if (lapara.Count == 1)
                    {
                        ...
                        string url1 = "http://decapi.me/youtube/videoid?search=" + linksillo;
                        //    webBrowser1.Navigate(url1);
            ...
            if (this.axWindowsMediaPlayer1.playState == WMPLib.WMPPlayState.wmppsMediaEnded)
            {
                ...
                if (lapara.Count >= 1)
                {
                    ...
                    if (loc1 > lapara.Count-1 && checkBox2.Checked == true)
                    {
                        ...
                        listBox1.SelectedIndex = loc1;
                        axWindowsMediaPlayer1.URL = "";
                        string url11 = "http://decapi.me/youtube/videoid?search=" + laparalink[loc1];
                   ...
                   if (loc1 <lapara.Count-1 && checkBox2.Checked == false)
                        {
                            ...
                            axWindowsMediaPlayer1.URL = "";
                            string url1 = "http://decapi.me/youtube/videoid?search=" + laparalink[loc1];
                            //  webBrowser1.Navigate(url1);
                            reproducir(laparalink[loc1]);
                            actualizarlista();
                        }
    ...
    public string agregaralalaista(string nombrepuro)
        {
            ...
            string url1 = "https://www.youtube.com/watch?v=" + gestordownload.DownloadString("http://decapi.me/youtube/videoid?search=" + nombrepuro.Replace(' ','+'));
        ...
        public string obtenernombreylink(string nombrepuro)
        {
            try
            {
                ...
                string url1 = "http://www.youtube.com/watch?v=" + gestordownload.DownloadString("http://decapi.me/youtube/videoid?search=" + nombrepuro.Replace(' ', '+'));
      ...
      public void reproducirlalista(int indice)
        {
          ...
          StreamReader  tupara = File.OpenText(Application.StartupPath + @"\Saved_playlist\" + name);
           ...
           string listilla1 = listainterna.Split('$')[0];
            ...
            /////////////////////////////////////////////////////////////////          
            axWindowsMediaPlayer1.URL = ""; 
            string url1 = "http://decapi.me/youtube/videoid?search=" + laparalink[0];
            //webBrowser1.Navigate(url1);
            reproducir(laparalink[0]);
        ...
        private void pictureBox34_Click(object sender, EventArgs e)
        {
            if (linkLabel1.Text != "") 
            {
                //  webBrowser1.Navigate("http://decapi.me/youtube/videoid?search=" + linkLabel1.Text);
